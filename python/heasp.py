...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_heasp')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_heasp')
...
class pha:
    ...
    def selectChannels(self, Start, End):
        return _heasp.pha_selectChannels(self, Start, End)

    def setGrouping(self, arg2):
        return _heasp.pha_setGrouping(self, arg2)

    def getGrouping(self):
        return _heasp.pha_getGrouping(self)

    def getMinCountsGrouping(self, *args):
        return _heasp.pha_getMinCountsGrouping(self, *args)

    def getMinSNGrouping(self, *args):
        return _heasp.pha_getMinSNGrouping(self, *args)
...
class rmf:
    ...
    def uncompress(self):
        return _heasp.rmf_uncompress(self)
    ...
    def interpolateAndMultiply(self, energies, factors):
        return _heasp.rmf_interpolateAndMultiply(self, energies, factors)
    ...
    def substituteRow(self, *args):
        return _heasp.rmf_substituteRow(self, *args)

    def multiplyByModel(self, model):
        return _heasp.rmf_multiplyByModel(self, model)

    def estimatedFWHM(self):
        return _heasp.rmf_estimatedFWHM(self)

    def estimatedFWHMperChannel(self):
        return _heasp.rmf_estimatedFWHMperChannel(self)
...
def binarySearch(energy, lowEnergy, highEnergy):
    return _heasp.binarySearch(energy, lowEnergy, highEnergy)
...
class grouping:
    ...
    def loadFromVector(self, QualVector, GroupVector):
        return _heasp.grouping_loadFromVector(self, QualVector, GroupVector)

    def loadOptimal(self, FWHM, Counts):
        return _heasp.grouping_loadOptimal(self, FWHM, Counts)

    def loadOptimalEnergy(self, FWHM, Counts):
        return _heasp.grouping_loadOptimalEnergy(self, FWHM, Counts)
